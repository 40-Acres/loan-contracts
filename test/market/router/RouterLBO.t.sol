...
contract RouterLBOTest is DiamondMarketTestBase {
    ...
    function test_success_buyTokenWithLBO_AEROInput_USDCListing_onVexy() public {
        ...
        // Calculate expected amounts
        uint256 upfrontProtocolFee = (listingPrice * 100) / 10000; // 100 bps
        uint256 externalRouteFee = (listingPrice * 200) / 10000; // 200 bps
        ...
        // verify loan details are correct including borrower=buyer, balance=maxLoan+financedFee, nft owner=loan
        assertEq(borrower, buyer, "Borrower should be buyer");
        assertEq(loanBalance, maxLoan + financedFee, "Loan balance should be maxLoan + financedFee");
