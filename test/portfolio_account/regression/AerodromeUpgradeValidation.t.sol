 ...
 * @dev Tests facet replacement mechanics and unauthorized upgrade access control.
 *      Extracted from fork/AerodromeUpgradeValidation — these tests don't need
 *      real veNFT collateral. State-preservation tests that need collateral
 *      remain in the fork suite.
 */
