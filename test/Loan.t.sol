...
contract LoanTest is Test {
    ...
    function testGetMaxLoan() public {
        ...
        (maxLoan,  ) = loan.getMaxLoan(tokenId, address(usdc));
    ...
    function testClaim() public {
        ...
        _loan.requestLoan(_tokenId, 0, Loan.ZeroBalanceOption.PayToOwner, 0, address(0), false, false, address(usdc));
        vm.stopPrank();
    ...
    function testMerge() public {
        ...
        vm.startPrank(_user);        
        IERC721(address(votingEscrow)).approve(address(loan), _tokenId);
        loan.requestLoan(_tokenId, 0, Loan.ZeroBalanceOption.PayToOwner, 0, address(0), true, false, address(usdc));
        vm.stopPrank();
