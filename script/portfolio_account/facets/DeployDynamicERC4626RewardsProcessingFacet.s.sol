...
/**
 * @title DeployDynamicERC4626RewardsProcessingFacet
 * @dev Deploy the rewards-processing facet for ERC4626 vault-share collateral on
 *      a live-debt-read lending pool. COLLATERAL_VAULT must match the vault used
 *      by the DynamicERC4626LendingFacet so debt and utilization reads stay
 *      consistent with borrow time.
 */
contract DeployDynamicERC4626RewardsProcessingFacet is AccountFacetsDeploy {
    ...
    function run() external {
        ...
        DynamicERC4626RewardsProcessingFacet facet = new DynamicERC4626RewardsProcessingFacet(
    ...
    ) external returns (DynamicERC4626RewardsProcessingFacet) {
        DynamicERC4626RewardsProcessingFacet facet = new DynamicERC4626RewardsProcessingFacet(
