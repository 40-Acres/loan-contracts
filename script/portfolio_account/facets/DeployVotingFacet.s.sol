...
contract DeployVotingFacet is AccountFacetsDeploy {
    function run() external {
        ...
        VotingFacet facet = new VotingFacet(PORTFOLIO_FACTORY, VOTING_CONFIG, VOTING_ESCROW, VOTER);
    ...
    function deploy(address portfolioFactory, address votingConfig, address votingEscrow, address voter) external {
        VotingFacet newFacet = new VotingFacet(portfolioFactory, votingConfig, votingEscrow, voter);
