...
contract AerodromeDynamicFeesRootDeploy is PortfolioFactoryConfigDeploy {
    ...
    function _deploy() internal {
        ...
        _vault.initialize(USDC, "40base-USDC-DYNAMIC-VAULT", "40base-USDC-DV", address(portfolioFactory), 8000, MULTISIG_ADDRESS, 2500);
        ...
        PortfolioMarketplace portfolioMarketplace = new PortfolioMarketplace(address(portfolioManager), address(VOTING_ESCROW), 100, DEPLOYER_ADDRESS, DEPLOYER_ADDRESS);
