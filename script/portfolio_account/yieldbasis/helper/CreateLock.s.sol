...
contract CreateLock is Script {
    ...
    function createLock(
        ...
        bytes4 selector = veYieldBasisFacet.createLock.selector;
        address facet = facetRegistry.getFacetForSelector(selector);
        require(facet != address(0), "veYieldBasisFacet.createLock not registered in FacetRegistry. Please deploy facets first.");
