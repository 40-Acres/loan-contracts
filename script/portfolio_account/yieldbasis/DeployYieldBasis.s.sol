...
contract YieldBasisRootDeploy is PortfolioFactoryConfigDeploy {
    ...
    function _deploy() internal {
        ...
        ERC1967Proxy vaultProxy = new ERC1967Proxy(
            address(vaultImpl),
            abi.encodeCall(DynamicFeesVault.initialize, (USDC, "40eth-USDC-DYNAMIC-VAULT", "40eth-USDC-DV", address(portfolioFactory), msg.sender, 2500))
        );
...
contract YieldBasisRootUpgrade is PortfolioFactoryConfigDeploy {
    ...
    function upgradeFacets() internal {
        ...
        collateralSelectors[7] = BaseCollateralFacet.getLoanUtilization.selector;
