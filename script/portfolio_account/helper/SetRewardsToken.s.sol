...
contract SetRewardsToken is Script {
    ...
    function setRewardsToken(
        ...
        bytes4 selector = RewardsConfigFacet.setRewardsToken.selector;
        address facet = facetRegistry.getFacetForSelector(selector);
        require(facet != address(0), "RewardsConfigFacet.setRewardsToken not registered in FacetRegistry. Please deploy facets first.");
