...
/**
 * @title MarketDeployLoanListingsAERO
 * @notice Enables loan listings and LBO for AERO Market Diamond on Base
 * @dev Script 2: Run after MarketDeployInitAERO.s.sol to enable loan features
 * 
 * Prerequisites:
 * 1. Run MarketDeployInitAERO.s.sol first
...
contract MarketDeployLoanListingsAERO is Script {
    
    // ============================================================================
    // CONFIGURATION - Update these from MarketDeployInitAERO.s.sol output
    // ============================================================================
    ...
    address constant LOAN_CONTRACT = 0x87f18b377e625b62c708D5f6EA96EC193558EFD0;
    
    // @dev Configure Loan asset (for LBO flash loans)
    address constant LOAN_ASSET = 0x833589fCD6eDb6E08f4c7C32D4f71b54bdA02913; // USDC on Base
    ...
    function run() external {
        ...
        console.log("The AERO market now supports:");
